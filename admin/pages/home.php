...
<!--                                 <li>
                ...
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-group"></i>&nbsp;Data Mahasiswa</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a type="button" class="btn btn-primary" href="#" data-toggle="modal" data-target="#modalImport"><i class="glyphicon glyphicon-import"></i>&nbsp;Import</a>
                                    <a type="button" class="btn btn-primary" href="#" data-toggle="modal" data-target="#modalTambah"><i class="fa fa-plus"></i>&nbsp;Tambah</a>
                                      ...
                                      <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            ...
                                            <h2 class="modal-title"><i class="fa fa-user"></i>&nbsp;Tambah Data Mahasiswa</h2>
                                        </div>
                                        <div class="modal-body">
                                            <form role="form" method="POST" action="edit_mahasiswa.php">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" placeholder="Enter text" name="informasi" id="informasi">
                                                    <?php
                                                    $query= $konek-> query('SELECT * FROM kategori_media');
                                                    while ($data= mysqli_fetch_array($query)) {
                                                        echo "<option value='".$data['Nama_media']."'>".$data['Nama_media']."</option>";
                                                    } ?>
                                                </select>
                                            </div>
            ...
            <div class="panel-body">
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                     <?php
                     $query= $konek-> query('SELECT * FROM tb_mahasiswa');
                     while ($data= mysqli_fetch_array($query)) {
                         ?>
                         <tr>
                             ...
                             <td width="100" align="center">
                                 <div class="btn-group btn-group-sm" >
                                    <a class="btn btn-primary" href="edit_mahasiswa.php?aksi=<?php echo $data['NPM']; ?>"><i class="fa fa-pencil-square-o"></i></a>
                                    <a class="btn btn-danger" href="delete.php?NPM=<?php echo $data['NPM']; ?>"><i class="fa fa-trash-o"></i></a>
                                </div>
                            </td> 
...
<div id="modalImport" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h2 class="modal-title"><i class="glyphicon glyphicon-import"></i>&nbsp;Import Data Mahasiswa</h2>
        </div>
        <div class="modal-body">
            <form role="form" method="POST" action="import.php" enctype="multipart/form-data">
                <div class="form-group">
                    <label>Masukkan Data Mahasiswa</label>
                    <input class="form-control" name="file" type="file">
                </div>
                <div class="modal-footer">
                    <button type="submit" name="simpan" class="btn btn-primary"><i class="glyphicon glyphicon-saved"></i>&nbsp;Import</a></button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-remove"></i>&nbsp;Close</button>
                </div>   
            </form>
        </div>
...
<div class="modal-content">
  <div class="modal-header">
    <h5 class="modal-title">copyrigth@Basri | 2015020011</h5>
...
if (isset($_POST['simpan'])) {
    ...
    $query = $konek->query("INSERT INTO tb_mahasiswa VALUES ('$NPM','$nama','$jenis_kelamin','$tempat_lahir','$tgl_lahir','$lulusan','$asal_daerah','$informasi') ");
    if ($query) {
