        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                        ...
                        <ul class="nav" id="side-menu">
                            <li class="sidebar-search">
                                ...
                                <!-- <li>
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa-edit fa-fw" > </i>PROSES<span class="fa arrow"></span></a>
                                        <ul class="nav nav-second-level">
                                            <li>
                ...
                <div id="page-wrapper">
                    ...
                    <!-- /.row -->
                    <form action="daerah.php" method="GET" enctype="multipart/form-data">
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                <tr>
                                    <th class="center">Centroid</th>
                                    <th class="center">Alternatif</th>
                                    <th class="center">Media Promosi</th>                                                                     
                                </tr>
                            </thead>
                            <tbody>
                                <?php 
                        ...
                        KETERANGAN:<BR>    
                        C1 = EFEKTIF <BR>
                        C2 = SEDANG EFEKTIF<BR>
                        C3 = KURANG EFEKTIF<BR>
                        <!-- /.table-responsive -->
                    </div>
                    <!-- /.panel-body -->
                </div>
