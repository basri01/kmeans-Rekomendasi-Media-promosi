        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">ASAL SEKOLAH SMA SEDERAJAT</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                ...
                                <tbody>
                                 <?php
                                 $query= $konek-> query('SELECT * FROM tb_claster2');
                                 while ($data= mysqli_fetch_array($query)) {
                                     ?>
                                     <tr>
                                         <td><?php echo $data['lulusan']; ?></td>
                                         <td><?php echo $data['media_cetak']; ?></td>
                                         <td><?php echo $data['media_elektronik']; ?></td>
                                         <td><?php echo $data['media_online']; ?></td>
                                         <td><?php echo $data['personal_salling']; ?></td>
                                         <td><?php echo $data['pendekatan']; ?></td>
                                 ...
                                 <!-- /.table-responsive -->
                                 <!-- /.table-responsive -->
                                 <a type="button" href="proses2.php" class="btn btn-primary" name="upload"><i class="fa fa-spinner"></i>&nbsp;Proses Metode</a>
                             </div>
                             <!-- /.panel-body -->
                         </div>
                         <!-- /.panel -->
