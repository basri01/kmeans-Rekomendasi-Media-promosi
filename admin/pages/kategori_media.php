...
<!--                                 <li>
                ...
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header" ><i class="fa fa-maxcdn"></i>&nbsp;Data Media</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                                          ...
                                          <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                              <div class="modal-header">
                                                ...
                                                <h2 class="modal-title"><i class="fa fa-maxcdn"></i>&nbsp;Tambah Media</h2>
                                            </div>
                                            <div class="modal-body">
                                                <form role="form" method="POST">
                                                    <div class="form-group">
                                                    <div class="form-group">
                                                        <input class="form-control" type="text" placeholder="Kd_media" name="Kd_media" id="Kd_media">
                                                        
                                                    </div>
                                                    <div class="form-group">
                                                        <input class="form-control" type="text" placeholder="Nama_media" name="Nama_media" id="Nama_media">
                                                    </div>
                        ...
                        <tbody>
                         <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th class="center">Kode Media</th>
                                        <th class="center">Nama Media</th>
                                   ...
                                   <tr>
                                       ...
                                       <td width="100" align="center">
                                           ...
                                           <!--  <button type="button" class="btn btn-primary btn-edit"
                                            data-iddaerah="<?php echo $data['Kd_media']; ?>"
                                            data-Kota="<?php echo $data['Nama_media']; ?>"
                                            ><i class="fa fa-pencil-square-o"></i></button> -->
                                            <a class="btn btn-danger" href="deletem.php ?Kd_media=<?php echo $data['id']; ?>"><i class="fa fa-trash-o"></i></a>
                                        </div>
                                    </td>
...
<div id="modaledit" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-body">
        <form role="form" method="POST">
            <div class="form-group">
                <input class="form-control" placeholder="Kd_media" name="Kd_media" id="Kd_media">

            </div>
            <div class="form-group">
                <input class="form-control" placeholder="Nama_media" name="Nama_media" id="Nama_media">
            </div>
            <div class="modal-footer">
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn-edit', function(e) {
            ...
            $('.Kd_media').val($(this).data('Kd_media'));
            $('.Nama_media').val($(this).data('Nama_media'));
        });
    });
    // </script>
...
if (isset($_POST['simpan'])) {
    $Kd_media=$_POST['Kd_media'];
    $Nama_media=$_POST['Nama_media'];
    


    $query = $konek->query("INSERT INTO kategori_media VALUES ('$Kd_media','$Nama_media') ");
    if ($query) {
        echo "<script>alert('Data Tersimpan');parent.location='kategori_media.php';</script>";
    }
    else {
