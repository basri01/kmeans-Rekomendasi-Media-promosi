...
<!--                                 <li>
                ...
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><i class="fa fa-user"></i>&nbsp;Data Grafik Mahasiswa Berdasarkan Tahun</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    $sql1 = "SELECT * FROM tb_mahasiswa WHERE NPM LIKE '2018%'";
                                    $query1 = $konek->query($sql1);
                                    $jumlah1 = $query1->num_rows;
                                    $sql2 = "SELECT * FROM tb_mahasiswa WHERE NPM LIKE '2017%'";
                                    $query2 = $konek->query($sql2);
                                    $jumlah2 = $query2->num_rows;
                                    $sql3 = "SELECT * FROM tb_mahasiswa WHERE NPM LIKE '2016%'";
                                    $query3 = $konek->query($sql3);
...
<script>
    ...
    Highcharts.chart('container', {
        ...
        title: {
            text: 'Data Mahasiswa Berdasarkan Tahun Maasuk'
        },
        subtitle: {
            text: ''
        },
