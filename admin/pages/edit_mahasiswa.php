...
<!--                                 <li>
                ...
                include "koneksi.php";
                $NPM = $_GET['aksi'];
                $query = $konek->query("SELECT * FROM tb_mahasiswa WHERE NPM = '$NPM'");
              ...
              <div id="page-wrapper">
                ...
                <div class="modal-body">
                    <form role="form" method="POST" >
                       <div class="form-group">
                        ...
                        <input class="form-control" name="NPM" value="<?php echo $NPM; ?>" >
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="date" value="<?php echo $tgl_lahir; ?>" name="tgl_lahir" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" placeholder="Provensi Sulawesi Selatan-Barat" name="asal_daerah" >
                         <?php
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" placeholder="Enter text" name="informasi" >
                        <?php
            ...
            <div class="modal-footer">
                <button type="submit" name="simpan" class="btn btn-primary" href="edit_mahasiswa.php ?aksi=<?php echo $data['NPM']; ?>" ><i class="glyphicon glyphicon-pencil"></i>&nbsp;Update</a></button>
            </div>  
        </form>
