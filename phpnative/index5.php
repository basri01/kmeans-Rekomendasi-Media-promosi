...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    // $data = [
    //   [0, 0, 0], [1, 1, 3], [1, 3, 2], [1, 4, 1]
    // ];

    $data = [
      [0, 3, 3], [118, 71, 46], [3, 12, 2], [149, 105, 58],
      [4, 0, 0], [137, 62, 10], [0, 0, 16], [20, 15, 46],
      [25, 5, 6], [0, 3, 0], [194, 151, 88], [59, 134, 46],
      [156, 98, 0], [21, 44, 0], [102, 75, 14], [0, 1, 0],
      [96, 123, 30], [0, 0, 1], [0, 4, 0], [9, 3, 0],
      [15, 5, 10], [65, 43, 6], [5, 2, 0], [0, 0, 2],
      [0, 4, 0], [13, 0, 0]
    ];
